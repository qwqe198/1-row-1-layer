...
if(hasMilestone("mba", 1))setBuyableAmount(this.layer, 25, player.bg.g.max(1).mul(layers.oss.sseff2()).log10().div(57500).max(1).log10().div(0.1673173347481761).max(0).floor().add(1).max(getBuyableAmount("tes", 25)))
//永恒
